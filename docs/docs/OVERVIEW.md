...
| -------------------------------- | ------------------------------ | ----------------------------------- |
| `Contributor` _or_               | Communication Service resource | Full management access (simplified) |
| `CommunicationServiceEmail.Send` | ACS                            | Send emails                         |
| `CommunicationService Reader`    | ACS                            | Read service properties             |
